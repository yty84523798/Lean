...
namespace QuantConnect.Brokerages.InteractiveBrokers.Client
{
    ...
    public sealed class OrderStatusEventArgs : EventArgs
    {
        ...
        {
            return $"OrderId: {OrderId}, Status: {Status}, Filled: {Filled}, Remaining: {Remaining}, AverageFillPrice: {AverageFillPrice}, PermId: {PermId}, ParentId: {ParentId}, LastFillPrice: {LastFillPrice}, ClientId: {ClientId}, WhyHeld: {WhyHeld}, MktCapPrice: {MktCapPrice}";
        }
    }
}